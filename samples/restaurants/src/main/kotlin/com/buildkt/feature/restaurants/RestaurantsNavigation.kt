...
private const val DETAIL_PANE_ROUTE = "restaurants/detail?addressId={addressId}"

private fun detailPaneRoute(restaurantId: String) = DETAIL_PANE_ROUTE.replace("{restaurantId}", restaurantId.toString())
